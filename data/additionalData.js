const Books = [{
    'Turtles All the Way Down': [{
        ...
        src: './images/AddImg/additionalContentImages/Books/turtles.jpg',
    }, 
    {
        attribute: 'No Judge',
    ...
    'Sherlock Holmes': [{
        ...
        src: './images/AddImg/additionalContentImages/Books/Sherlock.jpg',
    ...
    'Death\'s End': [{
        ...
        src: './images/AddImg/additionalContentImages/Books/Death\'s.jpg',
...
},
{
    'The Lord Of the Rings': [{
        ...
        src: './images/AddImg/additionalContentImages/Books/LOTR.jpg',
...
}, 
{
    'Rich Dad, Poor Dad': [{
        ...
        src: './images/AddImg/additionalContentImages/Books/Rich.jpg',
...
const Movies = [
    {
        ...
        'Thriller': [{
            ...
            src: './images/AddImg/additionalContentImages/Movies/Dark.jpg',

        }, 
        {
            movie: 'Se7en',
            rationale: 'The clever detective work & criminal cunning driving each other.',
            src: './images/AddImg/additionalContentImages/Movies/Se7en.jpg',

        }, {
            movie: 'Green Mile',
            rationale: 'Showcasing the message of how humanity can destriy its own miracles.',
            src: 'images/AddImg/additionalContentImages/Movies/Green.jpg',
        ...
        'Action': [{
            ...
            src: './images/AddImg/additionalContentImages/Movies/Inception.jpg',

        }, 
        {
            movie: 'John Wick',
            rationale: 'Action-packed movie that never stops for a second.',
            src: './images/AddImg/additionalContentImages/Movies/John.jpg',

        }, {
            movie: 'Ocean Eleven',
            rationale: 'A series of heists with intelligent & diligent planning.',
            src: './images/AddImg/additionalContentImages/Movies/Ocean.jpg',
        }
    ]
    },
    {
        'Science Fiction': [{
            ...
            src: './images/AddImg/additionalContentImages/Movies/Guardians.jpg',
        }, 
        {
            movie: 'Avatar',
            rationale: 'The ability to transfer conscious and memories to extra-terrestrial bodies is simply astonishing.',
            src: './images/AddImg/additionalContentImages/Movies/Avatar.jpg',
        }, {
            movie: 'Interstellar',
            rationale: 'The best movie showcasing astronomical theories',
            src: './images/AddImg/additionalContentImages/Movies/Inter.jpg',
        }
    ]
    ...
    }, 
    {
        'Comedy': [{
            ...
            src: './images/AddImg/additionalContentImages/Movies/Home.jpg',
        }, 
        {
            movie: 'Coming To America',
            rationale: 'A clever production of a humble king in civil disguise',
            src: './images/AddImg/additionalContentImages/Movies/America.jpg',
        }, {
            movie: 'MASK',
            rationale: 'Adopted from one of my favourite animation series.',
            src: './images/AddImg/additionalContentImages/Movies/MASK.jpg',
        }
    ]
    }
];
...
const Hobbies = [
    {
        'Weight liting': [{
            ...
            pr: '75Kg',
            src: './images/AddImg/additionalContentImages/Hobbies/Bench.jpg',

        }, 
        {
            exercise: 'Deadlift',
            pr: '110Kg',
            src: './images/AddImg/additionalContentImages/Hobbies/Dead.jpg',

        }, {
            exercise: 'Squat',
            pr: '75Kg',
            src: './images/AddImg/additionalContentImages/Hobbies/Squat.jpg',
        ...
        'Multi-disciplinary books reading': [{
            ...
            src: './images/AddImg/additionalContentImages/Hobbies/GAML.jpg',

        }, 
        {
            Book: 'Pattern Recognision & ML',
            Discipline: 'A pure mathematical approach in tackling Machine Learning. (In progress).',
            src: './images/AddImg/additionalContentImages/Hobbies/PRML.jpg',
    ...
    },
    {
        'Gaming': [{
            ...
            rationale: 'The introduction of third person view to graphics, the story, the mixture of horro and action, is all on-spot.',
            src: './images/AddImg/additionalContentImages/Hobbies/RE4.webp',

        }, 
        {
            game: 'Devil May Cry',
            rationale: 'The intellectual journey to the imaginary depth of the underworld.',
            src: './images/AddImg/additionalContentImages/Hobbies/DMC.jpg',

        }, {
            game: 'Horizon Forbidden West',
            rationale: 'Showcasing the potential future of humanity after an AI terraforming system goes rogue.',
            src: './images/AddImg/additionalContentImages/Hobbies/HRFW.webp',
    ...
    }, 
    {
        'Travelling solo/social circle': [{
            ...
            src: './images/AddImg/additionalContentImages/Hobbies/Aus.webp',
        }, 
        {
            destination: 'UK',
            rationale: 'Where I established my Bachelor degree, along with the mixture of memories of my adolescence.',
            src: './images/AddImg/additionalContentImages/Hobbies/UK.jpg',
        }, {
            ...
            src: './images/AddImg/additionalContentImages/Hobbies/HK.jpg',
        }
    ]
    }
];
